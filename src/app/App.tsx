...
import {AddVideoLessonsByModuleAndCourse} from "../pages/admin/coursePages/AddVideoLessonsByModuleAndCourse";
import {CourseUploadLessonVideo} from "../pages/admin/coursePages/CourseUploadLessonVideo";
import {ModuleByCourse} from "../pages/client/ModuleByCourse";
        ...
        <BrowserRouter>
            <Routes>
                <Route path={"/"} element={<DashboardLayout/>}>
                    ...
                    <Route path={"/auth/dashboard/course/:id/video-add"} element={<CourseUploadLessonVideo/>}/>
                    <Route path={"/auth/dashboard/course/:id/lesson-add"}
                           element={<AddVideoLessonsByModuleAndCourse/>}/>
                ...
                <Route path={"/course/:id/modules"} element={<ModuleByCourse/>}/>
